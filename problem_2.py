...
def solution(s):
    leftDirectionersIndexes = []
    rightDirectionersIndexes = []
    count = 0

    for i in range(len(s)):
        if s[i] == '>':
            rightDirectionersIndexes.append(i)
        elif s[i] == '<':
            leftDirectionersIndexes.append(i)
        elif s[i] == '-':
            continue
        else:
            return count

    if len(leftDirectionersIndexes) == 0 or len(rightDirectionersIndexes) == 0:
        return count

    for i in rightDirectionersIndexes:
        for j in leftDirectionersIndexes:
            if j > i:
                count = count + 1

    for i in leftDirectionersIndexes:
        for j in rightDirectionersIndexes:
            if i > j:
                count = count + 1
